...
export function NewsCard({
  ...
  const href = isExternal ? externalUrl : `/news/${slug}`;
  ...
  return (
    <article className="news-card">
      ...
      <div className="news-body">
        ...
        <CardWrapper className="news-link" {...linkProps}>
          {isExternal ? "Auf Instagram ansehen" : "Weiterlesen"}
        </CardWrapper>
      </div>
    </article>
  );
